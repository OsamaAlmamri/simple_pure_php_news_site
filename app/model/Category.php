...
//
    ...
    public function mainCategories($aData)
    {
        ...
        $oStmt = $this->db->preparation('SELECT id ,name_ar FROM categories WHERE name_ar LIKE  ?  and isMain=1 and parent=0');
    ...
    public function add(array $aData)
    {
        ...
        $oStmt = $this->db->preparation('INSERT INTO categories (  name_ar, name_en, parent, liveNews, newsCount, section_count, isMain, hasSlides, sort, status,
    ...
    public function update(array $aData)
    {
        ...
        $oStmt = $this->db->preparation('update  categories set name_ar =:name_ar, name_en=:name_en, parent=:parent, liveNews=:liveNews,
    ...
    public function delete($id)
    {
        ...
        $oStmt = $this->db->preparation('delete from  categories  WHERE id LIKE  ? ');
